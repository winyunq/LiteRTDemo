...
/**
 * SUmgMcpAgentResponseGroup
 * AI 消息表现层：实现经典的左侧对齐气泡，集成头像与回复文本。
 */
class UMGMCP_API SUmgMcpAgentResponseGroup : public SCompoundWidget
{
public:
	SLATE_BEGIN_ARGS(SUmgMcpAgentResponseGroup) {}
...
private:
	FString AgentName;
	FString MessageText;
	TSharedPtr<class SUmgMcpAgentStatusBar> AgentStatusBarWidget;
...
public:
	/** 将一个复杂的工具请求组控件（如 SUmgMcpMcpApprovalQueue）添加到消息气泡中 */
