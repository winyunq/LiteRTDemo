...
/**
 * SUmgMcpSystemNotificationWidget
 * 系统消息表现层：实现居中的通知文本，支持错误重试按钮。
 */
class UMGMCP_API SUmgMcpSystemNotificationWidget : public SCompoundWidget
{
public:
	SLATE_BEGIN_ARGS(SUmgMcpSystemNotificationWidget) {}
