...
private:
	...
	TSharedPtr<FJsonObject> GetEvents(class UWidgetBlueprint* Blueprint, const TSharedPtr<FJsonObject>& Params);
	TSharedPtr<FJsonObject> ReadBluecodeFunction(UEdGraph* Graph, const TSharedPtr<FJsonObject>& Params);
	TSharedPtr<FJsonObject> ApplyBluecode(UEdGraph* Graph, class UWidgetBlueprint* Blueprint, const TSharedPtr<FJsonObject>& Params);
	TSharedPtr<FJsonObject> ApplyBluecodeVariables(class UWidgetBlueprint* Blueprint, const TSharedPtr<FJsonObject>& Params);
	TSharedPtr<FJsonObject> ApplyBluecodeConnect(UEdGraph* Graph, const TSharedPtr<FJsonObject>& Params);
	TSharedPtr<FJsonObject> DeleteBluecode(class UWidgetBlueprint* Blueprint, UEdGraph* Graph, const TSharedPtr<FJsonObject>& Params);
	...
	TSharedPtr<FJsonObject> SearchNodes(UEdGraph* Graph, class UWidgetBlueprint* Blueprint, const TSharedPtr<FJsonObject>& Params);
