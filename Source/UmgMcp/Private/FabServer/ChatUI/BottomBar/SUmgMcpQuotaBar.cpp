...
void SUmgMcpQuotaBar::Construct(const FArguments& InArgs)
{
	...
	[
		...
		[
			...
			[
				SNew(STextBlock)
				.Text(TAttribute<FText>::Create(TAttribute<FText>::FGetter::CreateSP(this, &SUmgMcpQuotaBar::GetQuotaText)))
...
FText SUmgMcpQuotaBar::GetQuotaText() const
{
