...
#include "FabServer/ChatUI/BottomBar/SUmgMcpChatModeLabel.h"

#include "Internationalization/Culture.h"
#include "Internationalization/Internationalization.h"
#include "Widgets/Text/STextBlock.h"

void SUmgMcpChatModeLabel::Construct(const FArguments& InArgs)
{
	...
	[
		SNew(STextBlock)
		.Text(this, &SUmgMcpChatModeLabel::GetModeDisplayText)
	];
}

FText SUmgMcpChatModeLabel::GetModeDisplayText() const
{
...
FText SUmgMcpChatModeLabel::GetLocText(const FString& English, const FString& Chinese) const
{
